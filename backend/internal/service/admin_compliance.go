...
const (
	...
	AdminComplianceDocumentURLZH  = "https://github.com/zcj-ui/sub2api-plus/blob/main/docs/legal/admin-compliance.zh.md"
	AdminComplianceDocumentURLEN  = "https://github.com/zcj-ui/sub2api-plus/blob/main/docs/legal/admin-compliance.en.md"
