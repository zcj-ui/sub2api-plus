...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	rateLimitService := service.ProvideRateLimitService(accountRepository, usageLogRepository, configConfig, geminiQuotaService, tempUnschedCache, timeoutCounterCache, openAI429CounterCache, openAI403CounterCache, settingService, compositeTokenCacheInvalidator)
	...
	openAIGatewayService.SetSessionLimitCache(sessionLimitCache)
	...
	accountTestService := service.ProvideAccountTestService(accountRepository, geminiTokenProvider, claudeTokenProvider, grokTokenProvider, antigravityGatewayService, httpUpstream, configConfig, tlsFingerprintProfileService, openAIGatewayService, rateLimitService, settingService, openAIQuotaService, pluginManager)
