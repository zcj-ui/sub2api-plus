...
当前版本：`0.2.11`（本轮源码工具链 Go `1.27.0`；文中早期版本条目保留为历史记录）

## 0.2.11 官方最新同步说明（2026-09-05）

本版本紧跟 `Wei-Shaw/sub2api` 官方 `upstream/main` 最新提交 `b1748c4ea9`，在 `0.2.9` 的 Plus 定制基础上同步官方近期协议、模型、计费和管理端更新。同步范围覆盖官方 `v0.1.184`、`v0.1.185` 之后的主线提交，Plus 的代理强制绑定、Credits、卡 429、指纹四档和账户调度规则继续保留。
