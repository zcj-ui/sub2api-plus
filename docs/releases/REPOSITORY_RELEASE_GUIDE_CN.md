...
开发工作流从 `backend/cmd/server/VERSION` 推导下一个补丁版本，例如 `0.2.1-dev.42.1a2b3c4d`，构建 Linux、Windows、macOS 的 amd64/arm64 归档（Windows arm64 除外），并发布 `ghcr.io/zcj-ui/sub2api-plus:dev`。
