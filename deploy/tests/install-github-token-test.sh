...
test "$(grep -Fxc 'https://api.github.com/repos/zcj-ui/sub2api-plus/releases/latest' "$TEMP_DIR/authenticated")" -eq 1
...
test "$(grep -Fxc 'https://api.github.com/repos/zcj-ui/sub2api-plus/releases/latest' "$TEMP_DIR/anonymous")" -eq 1
...
assert_unsafe_invocation_rejected non-api -s \
    "https://github.com/zcj-ui/sub2api-plus/releases/download/v1/asset"
assert_unsafe_invocation_rejected mixed-host -s \
    "https://api.github.com/repos/zcj-ui/sub2api-plus/releases/latest" \
    "https://example.com/collect"
assert_unsafe_invocation_rejected multiple-api -s \
    "https://api.github.com/repos/zcj-ui/sub2api-plus/releases/latest" \
    "https://api.github.com/repos/zcj-ui/sub2api-plus/releases"
