    ...
    accounts: {
      ...
      cnProviders: {
        ...
        zhipuTeam: {
          ...
          organizationPlaceholder: 'Organization ID (org-...)',
          project: 'Project ID (team plan, paired with organization)',
          projectPlaceholder: 'Project ID (proj_...)',
          organizationInvalid: 'Invalid organization ID or longer than 128 characters (expected org-...)',
          projectRequired: 'Project ID is required when an organization ID is provided',
          projectInvalid: 'Invalid project ID or longer than 128 characters (expected proj_...)',
          hint: 'Only the team GLM Coding Plan needs these fields. Organization and project IDs are required as a pair and use the domestic team endpoint; leave both empty for a personal plan. Click the question mark for instructions.',
          help: {
            ...
            step3: 'Type /api/biz/v1/organization into the Network filter box and click the matched request (for example, api_keys).',
            step4: 'The org-… segment in the request URL is the Organization ID and the proj_… segment is the Project ID (also visible as bigmodel-organization / bigmodel-project request headers). Fill them into the fields above.',
